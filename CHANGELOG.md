...
- Index format 11 binds every root to its canonical local source or S3 endpoint, bucket, and prefix plus immutable content-pack metadata; searches may narrow that scope but reject broader or different sources.
