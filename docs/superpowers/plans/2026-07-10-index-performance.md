...
```bash
cargo +1.96.1 bench --locked -p s3grep-index --bench hot_paths -- index_build_1024x4096 --noplot
```
...
```bash
cargo +1.96.1 test --locked -p s3grep-core grams::tests::packed_sort_matches_control
```
...
```bash
cargo +1.96.1 test --locked -p s3grep-core grams::tests
cargo +1.96.1 bench --locked -p s3grep-index --bench hot_paths -- grams_index_trigram --noplot
```
...
```bash
cargo +1.96.1 test --locked -p s3grep-index build::runs::tests
```
...
```bash
cargo +1.96.1 nextest run --locked -p s3grep-index --all-features
```
...
```bash
cargo +1.96.1 nextest run --locked -p s3grep-index -p s3grep
```
