...
pub fn search_streaming(
    ...
    let query = s3grep_query::plan(pattern, reader.strategy())?;
...
mod tests {
    ...
    use s3grep_core::{DocAddress, SourceEncoding, Strategy};
    ...
    fn single_candidate_does_not_start_rayon_pool() {
        const PROBE: &str = "S3GREP_SINGLE_CANDIDATE_RAYON_PROBE";
