...
use crate::ColorArg;
use anyhow::Result;
use s3grep_core::{LineKind, SubMatch};
use s3grep_index::{DocResult, MatchSink, SinkFlow};
use std::io::Write;
...
fn binary_nul_offset(events: &[s3grep_core::LineEvent]) -> Option<u64> {
